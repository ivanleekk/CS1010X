...
public class BusEvent implements Comparable<BusEvent> {
    ...
    /**
     * Constructs a `BusEvent` with a given bus and time. This constructor (i.e. one
     * that takes in a time and bus) MUST
     * EXIST, though the constructor body can be modified if other instance
     * variables are added subsequently.
     */
    ...
    // Method that compares one `BusEvent` with another to determine the ordering.
    // The BusEvent with an earlier

...
def install_rational_package():
    ...
    def repord_to_reprat(x):
        return reprat(create_ordinary(x), create_ordinary(1))  # Replace this
    ...
    def RRmethod_to_ROmethod(method):
        return lambda rat, ord: method(rat, repord_to_reprat(ord))  # Replace this
    ...
    put("is_equal", ("ordinary", "rational"), RRmethod_to_ORmethod(is_equal_rat))
    ...
    put("is_equal", ("rational", "ordinary"), RRmethod_to_ROmethod(is_equal_rat))
...
def install_complex_package():
    ...
    def repord_to_repcom(x):
        return repcom(create_ordinary(x), create_ordinary(0))  # Replace this

    ###########
    # Task 2b #
    ###########
    def CCmethod_to_OCmethod(method):
        return lambda ord, com: method(repord_to_repcom(ord), com)  # Replace this

    def CCmethod_to_COmethod(method):
        return lambda com, ord: method(com, repord_to_repcom(ord))  # Replace this
